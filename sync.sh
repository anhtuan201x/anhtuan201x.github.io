...
<div class="description">
    ...
    Kho lưu trữ Tweak
    và ứng dụng Legacy dành cho iOS.
...
# Tạo lại Packages.bz2 ở thư mục gốc
bzip2 -fk Packages
...
if ! git diff --cached --exit-code --quiet; then
    ...
    git commit \
        -m "Bot: remove bundles and update Signed iOS Bundle link" \
        || true
...
echo " Signed iOS Bundle:"
echo " https://tlsroot.litten.ca/beeg.mobileconfig"
echo "=========================================="
